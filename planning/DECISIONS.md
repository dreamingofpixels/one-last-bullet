...
- **Why**: Gives a fast mid-combat aim steer without committing to a tether orbit; the arrow makes the pending direction readable; dash reset rewards the risk of standing near the orb and enables a dodge after batting.
- **Alternatives**: Re-enable arc-contact deflect — harder to read and couples melee with orb hits; redirect every in-range orb — chaotic with the 3-orb volley; keep melee swing on redirect — mixed fantasy and harder to telegraph; apply tether +10% on Attack redirect — would make batting stronger than sling without the orbit commitment; always-on aim control — removes positioning/timing.
- **Status**: decided (in-codebase)
