...
- `project/items/glyphs/glyph_rarity.gdshader` — canvas_item: lights dark center-rune pixels toward a rarity tint (Common white / Rare jade / Unique gold), all pulse in unison; per-item duplicated ShaderMaterial
