...
- **Status**: decided (in-codebase) for Blank→specialist Transform when `scene_path` exists (Ghost/Rot/Conduit); Attunement Transform not playable yet (no scenes); full 20-orb table still incomplete; hint inspect preview in-codebase
