...
- **Rot**: on enemy hit, applies **3 Poison** stacks. Poison ticks every **3 s** for damage equal to current stacks; stacks persist until the enemy dies (extra stacks do not reset the timer).
