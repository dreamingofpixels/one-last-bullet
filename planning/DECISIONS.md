...
- **Status**: decided (in-codebase) for Blank→specialist Transform when a scene resolves (Ghost/Contagion/Conduit/Vulcano/Runic); Attunement Transform not playable yet (no scenes); full 20-orb table still incomplete; live element-row hints (names only) plus 3-glyph OrbInfo preview in-codebase
