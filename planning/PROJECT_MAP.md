...
│   ├── enemy_attack_component.gd / .tscn  Enemy committed melee: proximity windup → hold frame → rect hitbox; optional self-lunge (`lunge_distance`) and victim shove (`hit_knockback_distance`); Chill speed_multiplier + stun cancel
